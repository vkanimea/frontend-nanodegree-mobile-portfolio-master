...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    // Remove determineDx as this is not needed, set a % width when the sizes change
    var newWidth;
...
function updatePositions() {
    ...
    // To Move the dom calculations outside of the for loop, store this in var topScroll
    var topScroll = (document.body.scrollTop / 1250);
    // Declare a phase as an array, to store 5 values
    var phaseArray = [];
    for (var i = 0; i < 5 ; i++) {
        phaseArray.push(Math.sin(topScroll + i ) * 100);
    }
